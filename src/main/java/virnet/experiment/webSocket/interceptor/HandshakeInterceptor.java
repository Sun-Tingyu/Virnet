	...
	public boolean beforeHandshake(ServerHttpRequest request,
		...
		if (request instanceof ServletServerHttpRequest) {
            ...
            if (session != null) {
            	...
            	System.out.println("(userName,workgroup,pageType,expRole):"+"("+userName+","+workgroup+","+pageType+","+expRole+")");
            	String expId;
				try {
					expId = session.getAttribute("expId").toString();//??
					System.out.println("(userName,workgroup,pageType,expRole,expId):"+"("+userName+","+workgroup+","+pageType+","+expRole+","+expId+")");
					attributes.put("WS_USER_expId",expId);
				} catch (Exception e) {
            	...
            	if(session.getAttribute("cabinetIP")!=null){
            		String cabinetIp = session.getAttribute("cabinetIP").toString();
                	System.out.println("cabinetIP :" + cabinetIp);
                	attributes.put("WS_USER_cabinetIP",cabinetIp);
            	}

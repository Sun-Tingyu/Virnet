...
public class ResourceAllocate {
	...
	public ResourceAllocate(String name_str, String enddate_str,String resourceServerIP) {
	...
	public boolean allocate() {
		...
		try {
			...
			outputdata.put("enddate_str", enddate_str);
	...
	public boolean reallocate() {
		...
		JSONObject outputdata = new JSONObject();
		try {
			outputdata.put("command_name", "reallocate");
			outputdata.put("name_str", name_Str);
			outputdata.put("enddate_str", enddate_str);
		} catch (JSONException e) {
			// TODO Auto-generated catch block
	...
	public Socket getConnectToServer() {
		System.out.println("getConnectToServer");
		return connectToServer;
	}

	public void setConnectToServer(Socket connectToServer) {

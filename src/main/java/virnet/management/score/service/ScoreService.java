...
public class ScoreService {
	...
	public Map<String, Object> LoadScoreInfo(String caseid, String taskid){
		...
		try {
			...
			if(tlist.get(0).toString().equals("1")){//RT
				equipmentport = "0@1"; 
			}
			if(tlist.get(0).toString().equals("2")){//SW3
//				equipmentport = "1@2@3@4@5@6@7@8"; 
				equipmentport = "9@10@11@12@13@14@15@16";
			}
			if(tlist.get(0).toString().equals("3")){//SW2
//				equipmentport = "1@2@3@4@5@6"; 
				equipmentport = "7@8@9@10@11@12";
			}
			if(tlist.get(0).toString().equals("4")){//PC
				equipmentport = "1"; 
			}
